          ...
          <Container className="containerhist2">
            <Row className="row">
              <Col md={{ span: 6, offset: 0 }} className="col1">
                <Card.Img variant="top" className="imghp" src="https://images.tokopedia.net/img/cache/300-square/product-1/2020/9/2/48125333/48125333_eb395cfa-025e-4c35-b52e-bb128514db19_700_700.webp?ect=4g" alt="gambar" />
              </Col>
