  ...
  return (
    <div>
          ...
          <Container className="content mb-5">
            <div className="pro-image">
                ...
                <div className='btn-add pt-3'>
                    <Button variant="info" type="submit" onClick={(e) => setImage(e.target.value)} value={image}>Add Picture</Button>
                </div>
            </div>
            <Form className="form">
                ...
                <Form.Group as={Row} className="mb-3" controlId="formPlaintextPassword">
                    ...
                    <Col sm="8">
                    <Form.Control type="text" placeholder="Quantity" onChange={(e) => setStock(e.target.value)} value={stock} />
                    </Col>
                </Form.Group>
        ...
        <Container className="sub-create pt-3">
          <Button variant="info" type="submit" style={{marginRight: '20px'}} onClick={() => klikSave()}>Save</Button>
